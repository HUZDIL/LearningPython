...
a = pd.concat([df1,df2]) # iki data frame i indexlere gore toplamis olduk
print(a)

b = pd.concat([df1,df2],axis=1) # kolonlara gore birlestirecek
...
a = pd.merge(df1,df2,how ="inner",on = "anahtar")
print(a)